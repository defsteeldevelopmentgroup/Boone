...
<html lang="en">
  <head>
    ...
    <!--END COMPILED CSS-->
        ...
        <link rel="stylesheet/less" type="text/css" href="<?php echo base_url()?>less/style.less<?php echo '?ver='.microtime(); ?>" rel="stylesheet" media="screen">
        <!--END RECOMPILE -->
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$( document ).ajaxStart(function() {
			    ...
			    $('<div class="fade" id="loading-indicator"><img id="loading-gif" src="<?=base_url();?>/images/ajax-loader.gif"  /></div>').prependTo(document.body);
